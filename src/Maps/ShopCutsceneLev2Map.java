...
public class ShopCutsceneLev2Map extends Map {
    ...
    public ShopCutsceneLev2Map() {
        super("shop_hall2.txt", new ForestTileset());
        ...
        Point maxIconLocation = getMapTile(2,0).getLocation().subtractX(57).subtractY(-8);
        ...
        vending_machine = new Sprite (ImageLoader.loadSubImage("vending_machine2.png", Colors.MAGENTA, 0, 0, 80, 90));
