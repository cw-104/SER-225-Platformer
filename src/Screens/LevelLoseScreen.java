...
public class LevelLoseScreen extends Screen {
    ...
    public void update() {
        ...
        if (Keyboard.isKeyDown(Key.SPACE) && !keyLocker.isKeyLocked(Key.SPACE)) {
            if(playLevelScreen.shopCheck < 2) {
                playLevelScreen.resetLevel();
            }
            else if(playLevelScreen.shopCheck == 2) {
                playLevelScreen.resetLevel2();
            }
           else if(playLevelScreen.shopCheck == 3) {
                playLevelScreen.resetLevel3();
           }
